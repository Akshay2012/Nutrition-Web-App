...
function wgerInitIngredientAutocompleter() {
  ...
  // https://wger.de/en/nutrition/meal/item/146065/item/add/
    ...
    source: function(name,response){
      ...
      $.ajax({
        ...
        success: function(data) {
            console.log(data);
            // $('#id_ingredient_searchfield').val(data.suggestions)
           response(data.suggestions)
        }
    });
    },
    minChars: 3,
    select: function(d,suggestion) {
      
      console.log("Inside autocomplete",suggestion)
      var ingredientId = suggestion.item.data.id;
      ...
      $.get('https://wger.de/api/v2/ingredientweightunit/?ingredient=' + ingredientId, function (unitData) {
        ...
        $.each(unitData.results, function (index, value) {
          $.get('https://wger.de/api/v2/weightunit/' + value.unit + '/', function (unit) {
  ...
  // $('#id_ingredient_searchfield').autocomplete({    
  //   source: 'https://wger.de/api/v2/ingredient/search/',
  //   paramName: 'term',
  //   minChars: 3,
